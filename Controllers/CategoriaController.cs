...
public class CategoriaController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> InsertCategoria([FromQuery] string nome)
    {
    ...
    [HttpPut("{idCategoria}")]
    public async Task<IActionResult> UpdateCategoria(int idCategoria, [FromQuery] string nome)
    {
